...
contract LabRegistry is Ownable, Pausable {
    ...
    function addReport(uint256 _id, string memory _res, string memory _tech, address _pat) public payable whenNotPaused {
